...
integration_str = "hive" # This could change to hive, drill, elastic etc.
...
setup_args = dict(
    ...
    long_description="A magic function for working with Apache Hive for Python3 based Jupyter Notebooks",
    author="John Omernik",
